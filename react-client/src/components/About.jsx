    ...
    <div name='main' className="w-full h-screen text-white">
      ...
      <div className="mx-auto p-4">
        <div className="project-box">
          ...
          boasts an engaging user interface, ensuring an interactive and enjoyable experience. Moreover, be sure to keep an eye out for hidden interactive easter eggs 
